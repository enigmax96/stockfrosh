...
class ChessEngine:
    ...
    search_info = "minimax search with depth 3 and alpha-beta pruning."
    ...
    def get_best_move(self, board):
        ...
        print(f"Best move for {'white' if board.turn == chess.WHITE else 'black'}: {best_value}")
    ...
    def minimax(self, board, depth, alpha, beta, maximizing_player):
        ...
        Calls evaluation for each found position and uses alpha-beta pruning.
        """
        if depth == 0 or board.is_game_over():
            self.positions_searched += 1  # Increment the counter for each evaluated position
